      ...
      <div class="hero">
        ...
        <div style="display: flex; justify-content: center">
          <p style="font-size: 30px">
            ...
            <el-link style="font-size: 30px" type="warning"
              ...
              target="_blank" rel="noopener noreferrer">点击去体验</el-link>
          </p>
        ...
        <el-card class="box-card">
          <el-alert title="重要提醒" type="warning">
            <p style="font-size: 20px">
              hub.{{ proxyDomain }} 拉取 dockerhub 仓库的域名被墙，更换为
              docker.{{ proxyDomain }}。
            </p>
            <p style="font-size: 20px">
              镜像拉取慢？试试单镜像加速通道
              <el-link style="font-size: 20px" type="primary"
                href="https://github.com/kubesre/docker-registry-mirrors?tab=readme-ov-file#%E5%BC%BA%E7%83%88%E6%8E%A8%E8%8D%90-%E5%8D%95%E9%95%9C%E5%83%8F%E5%8A%A0%E9%80%9F%E9%80%9A%E9%81%93"
                target="_blank">点击去体验</el-link>
            </p>
          </el-alert>
